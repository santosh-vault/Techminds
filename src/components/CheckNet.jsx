...
const CheckNet = () => {
  return (
    <div
      className=" text-white py-4 px-32 flex justify-between items-center"
    ...
    >
      ...
      <div className=" justify-between flex w-[535px] bg-white text-blue-900 py-2 px-4 rounded-full focus:outline-none">
        <input
          type="email"
